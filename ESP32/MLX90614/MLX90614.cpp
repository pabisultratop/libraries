...
*/
MLX90614::MLX90614(int i2c_sda, int i2c_scl, uint8_t i2caddr) {
  _addr = i2caddr;
  i2c_sda_ = i2c_sda;
  i2c_scl_ = i2c_scl;
}
...
bool MLX90614::Begin(void) {
  if (!Wire.begin(i2c_sda_, i2c_scl_))
  {
    Serial.println();
    Serial.println("Not founded Melexis MLX90614 infra-red temperature sensor");
    return false;
  }
  Serial.println();
  Serial.println("Melexis MLX90614 infra-red temperature sensor init");
  /*
